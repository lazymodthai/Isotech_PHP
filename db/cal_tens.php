...
<body>
    ...
    ?>
        ...
        <form action="insert_data_tens.php" method="post">
            <div class="container">
                ...
                <div div class="input-group mb-3">
                    ...
                    <input type="number" step="0.01" name="A_S_1" class="form-control" value="5">
                    <input type="number" step="0.01" name="A_S_2" class="form-control" value="10">
                    <input type="number" step="0.01" name="A_S_3" class="form-control" value="15">
                    <input type="number" step="0.01" name="A_S_4" class="form-control" value="20">
                    <input type="number" step="0.01" name="A_S_5" class="form-control" value="100">
                ...
                <div div class="input-group mb-3">
                    <span class="input-group-text col-3">Set</span>
                    <input type="number" step="0.01" name="B_S_1" class="form-control" value="10">
                    <input type="number" step="0.01" name="B_S_2" class="form-control" value="20">
                    <input type="number" step="0.01" name="B_S_3" class="form-control" value="70">
                    <input type="number" step="0.01" name="B_S_4" class="form-control" value="20">
                    <input type="number" step="0.01" name="B_S_5" class="form-control" value="100">
                ...
                <div div class="input-group mb-3">
                    <span class="input-group-text col-3">Set</span>
                    <input type="number" step="0.01" name="C_S_1" class="form-control" value="80">
                    <input type="number" step="0.01" name="C_S_2" class="form-control" value="120">
                    <input type="number" step="0.01" name="C_S_3" class="form-control" value="150">
                    <input type="number" step="0.01" name="C_S_4" class="form-control" value="180">
