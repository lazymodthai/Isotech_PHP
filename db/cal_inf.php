...
<body>
    ...
    ?>
        ...
        <form action="insert_data_inf.php" method="post">
            <div class="container">
                <h2>Cal Data : <span style="color:blueviolet">Infusion - Syring Pump</span></h2>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="IV_Set" class="form-control" placeholder="IV Set, Syringe size">
                </div>
                <div div class="input-group mb-3">
                    <span class="input-group-text col-3">Set (ml/h)</span>
                    <input type="number" step="0.01" name="Flow_S_1" class="form-control" value="5">
                    <input type="number" step="0.01" name="Flow_S_2" class="form-control" value="10">
                    <input type="number" step="0.01" name="Flow_S_3" class="form-control" value="25">
                    <input type="number" step="0.01" name="Flow_S_4" class="form-control" value="100">
                </div>
                <div class="input-group mb-3">
