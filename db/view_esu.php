...
<body style="background-color: black;">
  ...
  $sql = "SELECT *
  FROM cal_esu1 AS c1
  INNER JOIN cal_esu2 AS c2 ON c1.Code = c2.Code
  INNER JOIN cal_esu3 AS c3 ON c1.Code = c3.Code
  INNER JOIN cal_esu4 AS c4 ON c1.Code = c4.Code
  WHERE c1.Code LIKE '%$code%';";
