...
<html lang="en">
  <head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/underscore.js/1.13.1/underscore-esm-min.js"></script>
    <link
      rel="stylesheet"
    ...
    <script
      async
      src="https://www.googletagmanager.com/gtag/js?id=G-MVFLB5K9XT"
    ></script>
    <script>
      ...
      gtag("config", "G-MVFLB5K9XT");
    </script>
    <script>
      $(function () {
        $("#navbar_home").load("navbar_home.php");
